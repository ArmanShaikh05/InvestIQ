...
const page = () => {
  return (
    <div className=" h-[calc(100vh-4.6rem)] pt-4 flex flex-col gap-8 overflow-y-auto">
      {/* Greetings Box */}
      <div className="w-full border rounded-4xl dark:bg-[linear-gradient(135deg,rgba(47,40,32,0.7)_0%,rgba(244,208,63,0.08)_100%)] py-10 px-6 md:px-20 lg:px-32 flex flex-col items-center shadow-lg shadow-ring/10">
      ...
      {/* Profile Overview */}
      <div className="w-full border rounded-4xl dark:bg-[linear-gradient(135deg,rgba(47,40,32,0.7)_0%,rgba(244,208,63,0.08)_100%)] py-10 px-6 md:px-10  flex flex-col items-center shadow-lg shadow-ring/10">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-4  mt-8 max-[350px]:flex max-[350px]:flex-col">
          {profileOverviewData.map((item, index) => (
            <div className="w-full flex flex-col gap-2 items-center" key={index}>
