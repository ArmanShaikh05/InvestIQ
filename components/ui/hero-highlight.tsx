...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative z-10 inline-block rounded-lg bg-gradient-to-r from-[rgba(198, 160, 36,0.7)] to-[rgba(198, 160, 36,0.5)] px-1 pb-1 dark:to-[#c8a224] dark:from-[#f4d03f33] text-white`,
        className,
      )}
    >
      {children}
