      ...
      <div className="mx-auto max-w-screen-xl px-4 md:px-8">
        <div className="relative mx-auto max-w-2xl sm:text-center">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(152.92deg, rgba(198, 160, 32, 0.2) 4.54%, rgba(198, 160, 32, 0.26) 34.2%, rgba(198, 160, 32, 0.1) 77.55%)",
            }}
          ></div>
        </div>
        ...
        <div className="relative mt-12">
          <ul className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((item, idx) => (
              <li
                key={idx}
                className="transform-gpu space-y-3 rounded-xl border bg-transparent p-4 shadow-[inset_0_-20px_80px_-20px_rgba(198,160,32,0.2)] "
              >
                <div className="text-primary w-fit transform-gpu rounded-full border p-4 shadow-[inset_0_-20px_80px_-20px_rgba(198,160,32,0.2)] dark:shadow-[inset_0_-20px_80px_-20px_rgba(198,160,32,0.2)]">
                  {item.icon}
                </div>
