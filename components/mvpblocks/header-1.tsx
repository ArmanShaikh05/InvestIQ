...
export default function Header1() {
  ...
  useEffect(() => {
    ...
    // ✅ Run immediately on mount (in case page is already scrolled)
    handleScroll();
  ...
  return (
    <motion.header
      className={cn(
        ...
        isScrolled
          ? "backdrop-blur-[20px] dark:bg-background/40 shadow-[0_8px_32px_rgba(200,162,32,0.1)]"
          : "backdrop:blur-0 shadow-none bg-transparent"
      )}
        ...
        <div className="flex h-16 items-center justify-between lg:h-20">
          ...
          >
            <Link
              ...
              className="flex items-center space-x-2"
            >
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-primary/70 to-primary/50">
