...
const Valuation = () => {
  ...
  const getAssessmentBadge = (current: number, average: number, lowerIsBetter = false) => {
    ...
    if (lowerIsBetter) {
      if (diff < -20) return { color: "🟢", text: "Higher", variant: "default" as const, value: `+${absDiff.toFixed(0)}%` };
      if (diff > 20) return { color: "🔴", text: "Lower", variant: "destructive" as const, value: `-${absDiff.toFixed(0)}%` };
      return { color: "🟡", text: "Premium", variant: "secondary" as const, value: `+${absDiff.toFixed(0)}%` };
    } else {
      if (diff > 20) return { color: "🟡", text: "Premium", variant: "secondary" as const, value: `+${absDiff.toFixed(0)}%` };
      if (diff < -20) return { color: "🟢", text: "Discount", variant: "default" as const, value: `-${absDiff.toFixed(0)}%` };
      return { color: "🟡", text: "In-line", variant: "outline" as const, value: `${diff > 0 ? '+' : ''}${diff.toFixed(0)}%` };
    }
  };
  ...
  const getValuationScore = (peer: typeof peerData[0]) => {
    ...
    if (totalScore > 0.15) return { badge: "🟢 Cheap", variant: "default" as const };
    if (totalScore > 0.05) return { badge: "🟢 Value", variant: "default" as const };
    if (totalScore > -0.05) return { badge: "🟢 Fair", variant: "outline" as const };
    if (totalScore > -0.15) return { badge: "🟡 Premium", variant: "secondary" as const };
  ...
  const pegData = {
    ...
    currentPEG: 1.04,
    scenarios: [
      { growth: "20%+", peg: 0.93, assessment: "🟢 Attractive", label: "upside" },
      { growth: "15-18%", peg: "1.04-1.23", assessment: "🟡 Fair", label: "base" },
      { growth: "12-14%", peg: "1.32-1.54", assessment: "🔴 Expensive", label: "downside" },
    ],
    peerPEG: [
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Section Title */}
      <div>
        <h2 className="text-2xl font-bold tracking-tight">💰 Current Price & Valuation</h2>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center text-xs">
                <div className="text-left">
                  ...
                  <div className="text-muted-foreground">₹{stockData.fiftyTwoWeekLow.toLocaleString('en-IN')}</div>
                </div>
                <div className="text-center">
                  <div className="font-medium">Current Price</div>
                  <div className="text-primary font-bold">₹{stockData.currentPrice.toLocaleString('en-IN')}</div>
                ...
                <div className="text-right">
                  ...
                  <div className="text-muted-foreground">₹{stockData.fiftyTwoWeekHigh.toLocaleString('en-IN')}</div>
                </div>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <CardContent className="space-y-3">
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                "You pay ₹{stockData.pe} for every ₹1 of annual earnings"
              </p>
            </div>
            ...
            <div className="pt-2 border-t">
              <p className="text-xs text-muted-foreground italic">
                💡 Higher P/E = market expects strong future
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="pt-2 border-t">
              <p className="text-xs text-muted-foreground italic">
                💡 P/B &gt; 2 suggests quality premium
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="pt-2 border-t">
              <p className="text-xs text-muted-foreground italic">
                💡 Accounts for debt, cleaner than P/E
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          ...
          <CardContent className="space-y-3">
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                "₹{stockData.dividendYield} annual dividend per ₹100 invested"
              </p>
            </div>
            ...
            <div className="pt-2 border-t">
              <p className="text-xs text-muted-foreground italic">
                💡 Lower yield, company retaining cash for growth
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <div id="valuation-story" className="space-y-4 pt-8 border-t">
        ...
        {/* Section Title */}
        <div>
          <h2 className="text-2xl font-bold tracking-tight">📖 Understanding the Valuation</h2>
          <p className="text-sm text-muted-foreground mt-1">
      ...
      <div id="historical-context" className="space-y-4 pt-8 border-t">
        ...
        {/* Section Title */}
        <div>
          <h2 className="text-2xl font-bold tracking-tight">📊 Historical Valuation Bands</h2>
          <p className="text-sm text-muted-foreground mt-1">
                      ...
                      <div className="absolute left-1/2 top-0 -mt-1">
                        <div className="relative">
                          ...
                          <div className="absolute -left-20 -top-8 text-xs font-bold text-primary whitespace-nowrap">
                            ← You are here: {valuationStory.historicalPE.current}x
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <div id="peer-valuation" className="space-y-4 pt-8 border-t">
        ...
        {/* Section Title */}
        <div>
          <h2 className="text-2xl font-bold tracking-tight">⚖️ Peer Valuation Benchmarking</h2>
          <p className="text-sm text-muted-foreground mt-1">
                  ...
                  {peerData.map((peer) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="text-right py-3 px-2">₹{peer.price.toLocaleString('en-IN')}</td>
        ...
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
          <CardHeader>
            <CardTitle className="text-lg">📊 Valuation Positioning Analysis</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <div id="peg-analysis" className="space-y-4 pt-8 border-t">
        ...
        {/* Section Title */}
        <div>
          <h2 className="text-2xl font-bold tracking-tight">🚀 Growth vs Price Analysis</h2>
          <p className="text-sm text-muted-foreground mt-1">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-3 border-t">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    ₹{pegData.currentPEG} for each percentage point of growth. This is considered reasonable - 
      ...
      <div id="intrinsic-value" className="space-y-4 pt-8 border-t">
        ...
        {/* Section Title */}
        <div>
          <h2 className="text-2xl font-bold tracking-tight">💎 Fair Value Assessment</h2>
          <p className="text-sm text-muted-foreground mt-1">
            ...
            <CardContent className="space-y-3">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">₹{intrinsicValue.currentEPS}</span>
                </div>
                <div className="pt-2 border-t">
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Fair Value:</span>
                    <span className="text-xl font-bold text-primary">
                      ₹{intrinsicValue.peMethod.fairValue.toLocaleString('en-IN')}
                    </span>
                  </div>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Current Price:</span>
                  <span className="font-semibold">₹{stockData.currentPrice.toLocaleString('en-IN')}</span>
                </div>
            ...
            <CardContent className="space-y-3">
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">₹{intrinsicValue.currentBookValue}</span>
                </div>
                <div className="pt-2 border-t">
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Fair Value:</span>
                    <span className="text-xl font-bold text-primary">
                      ₹{intrinsicValue.pbMethod.fairValue.toLocaleString('en-IN')}
                    </span>
                  </div>
                </div>
                <div className="flex justify-between">
                ...
                <div className="pt-2 border-t">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-base font-bold text-primary">
                      ₹{intrinsicValue.dcfMethod.intrinsicRangeLow.toLocaleString('en-IN')} - 
                      ₹{intrinsicValue.dcfMethod.intrinsicRangeHigh.toLocaleString('en-IN')}
                    </span>
                  </div>
                </div>
                <div className="flex justify-between">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-xs pt-8">
                <div className="text-center">
                  <div className="font-semibold">₹{intrinsicValue.fairValueRange.undervalued.toLocaleString('en-IN')}</div>
                </div>
                <div className="text-center">
                  <div className="font-semibold">₹{intrinsicValue.fairValueRange.fairLow.toLocaleString('en-IN')}</div>
                </div>
                <div className="text-center">
                  <div className="font-semibold text-primary">₹{stockData.currentPrice.toLocaleString('en-IN')}</div>
                  <div className="text-primary mt-1">↑ Current</div>
                </div>
                <div className="text-center">
                  <div className="font-semibold">₹{intrinsicValue.fairValueRange.fairHigh.toLocaleString('en-IN')}</div>
                </div>
                <div className="text-center">
                  <div className="font-semibold">₹{intrinsicValue.fairValueRange.overvalued.toLocaleString('en-IN')}</div>
                </div>
              </div>
            </div>
      ...
      <div id="valuation-risks" className="space-y-4 pt-8 border-t">
        ...
        {/* Section Title */}
        <div>
          <h2 className="text-2xl font-bold tracking-tight">⚠️ Valuation Risk Assessment</h2>
          <p className="text-sm text-muted-foreground mt-1">
        ...
        <Card className="border-2">
          <CardHeader>
            ...
            <CardDescription>
              What returns can you expect under different scenarios? (Current price: ₹{stockData.currentPrice.toLocaleString('en-IN')})
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="overflow-x-auto">
      ...
      <div id="investment-framework" className="space-y-4 pt-8 border-t">
        ...
        {/* Section Title */}
        <div>
          <h2 className="text-2xl font-bold tracking-tight">🎯 Valuation Verdict</h2>
          <p className="text-sm text-muted-foreground mt-1">
              ...
              <div className="pt-3 border-t">
                ...
                <div className="p-3 bg-primary/5 rounded-lg border border-primary/20">
                  <p className="text-sm font-medium">
                    ✓ Can invest, but maybe average-in over time rather than lump sum
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border-2 border-yellow-200 dark:border-yellow-800 hover:shadow-xl transition-all">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-3 border-t">
                ...
                <div className="p-3 bg-primary/5 rounded-lg border border-primary/20">
                  <p className="text-sm font-medium">
                    🤔 Consider if you want steady compounding, not if you want rockets
                  </p>
                </div>
              </div>
            </CardContent>
