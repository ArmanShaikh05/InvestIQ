...
const TrendingTodayData: TrendingData[] = [
  {
    ...
    aiInsights: {
      portfolioAction: "Consider increasing position by 10-15%. Strong fundamentals with AI catalyst ahead.",
      riskAssessment: "Low risk with high growth potential. Temporary volatility expected near earnings.",
  ...
  },
  {
    ...
    aiInsights: {
      portfolioAction: "Strong buy signal for tech-focused portfolios. Consider 5-8% allocation increase.",
      riskAssessment: "Moderate risk due to high valuation. Long-term AI trend remains intact.",
  ...
  },
  {
    ...
    aiInsights: {
      portfolioAction: "Volatile but strong upside potential. Consider dollar-cost averaging approach.",
      riskAssessment: "High volatility expected. Suitable for growth-oriented investors with risk tolerance.",
  ...
  },
  {
    ...
    aiInsights: {
      portfolioAction: "Healthcare diversification opportunity. Consider 3-5% portfolio allocation.",
      riskAssessment: "Medium risk with biotech volatility. Strong pipeline mitigates concerns.",
  ...
  },
  {
    ...
    aiInsights: {
      portfolioAction: "Semiconductor recovery play. Good entry point for tech exposure diversification.",
      riskAssessment: "Moderate risk with cyclical volatility. Strong competitive position emerging.",
...
const TrendingToday = () => {
  ...
  return (
    <>
                ...
                <div className="flex items-start justify-between pr-12">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h2 className="text-xl font-bold mb-2">{activeStock.stockName}</h2>
                      <div className="flex items-center gap-2">
                        <Badge variant="outline" className="px-1.5 py-0.5 text-xs h-5">
                          {activeStock.symbol}
                        </Badge>
                        <Badge className="px-1.5 py-0.5 text-xs h-5">{activeStock.sector}</Badge>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold mb-1">{activeStock.price}</div>
                    <Badge
                      variant="success"
              ...
              <div className="p-6 max-h-[calc(90vh-200px)] overflow-y-auto space-y-6 custom-scrollbar">
                ...
                <div className="bg-gradient-to-br from-purple-500/5 to-transparent rounded-xl border border-purple-500/20 p-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-medium text-sm mb-1 pb-1 border-b border-purple-400/30">Portfolio Action</div>
                        <div className="text-sm text-muted-foreground">{activeStock.aiInsights.portfolioAction}</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <AlertTriangle className="w-4 h-4 text-yellow-400 mt-0.5 flex-shrink-0" />
                      <div>
                        <div className="font-medium text-sm mb-1 pb-1 border-b border-yellow-400/30">Risk Assessment</div>
                        <div className="text-sm text-muted-foreground">{activeStock.aiInsights.riskAssessment}</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <Calendar className="w-4 h-4 text-blue-400 mt-0.5 flex-shrink-0" />
                      <div>
                        <div className="font-medium text-sm mb-1 pb-1 border-b border-blue-400/30">Investment Timeframe</div>
                        <div className="text-sm text-muted-foreground">{activeStock.aiInsights.timeframe}</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 pt-2">
                      ...
                      <div className="flex-1 bg-muted rounded-full h-2">
                        <div 
                          ...
                          style={{ width: `${activeStock.aiInsights.confidence}%` }}
                        ></div>
                      </div>
                      <div className="text-sm font-semibold">{activeStock.aiInsights.confidence}%</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-background/50 rounded-xl border border-border/30 p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{activeStock.technicalAnalysis.support}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Resistance Level:</span>
                        <span className="font-medium">{activeStock.technicalAnalysis.resistance}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">RSI (14):</span>
                        <span className={`font-medium ${activeStock.technicalAnalysis.rsi > 70 ? 'text-red-400' : activeStock.technicalAnalysis.rsi < 30 ? 'text-green-400' : 'text-yellow-400'}`}>
                          {activeStock.technicalAnalysis.rsi}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">MACD Signal:</span>
                        <Badge variant={activeStock.technicalAnalysis.macd === "Bullish" ? "success" : "destructive"} className="text-xs">
                  ...
                  <div className="bg-background/50 rounded-xl border border-border/30 p-4">
                    ...
                    <div className="space-y-2">
                      <Button className="w-full justify-start text-sm bg-gradient-to-r from-green-500/30 to-emerald-600/10 hover:from-green-600/90 hover:to-emerald-700/90 text-white border border-green-500/30 backdrop-blur-sm shadow-lg" size="sm">
                        <PlusCircle className="w-4 h-4 mr-2" />
                        Add to Portfolio
                      </Button>
                      <Button className="w-full justify-start text-sm bg-gradient-to-r from-blue-500/30 to-cyan-600/10 hover:from-blue-600/90 hover:to-cyan-700/90 text-white border border-blue-500/30 backdrop-blur-sm shadow-lg" size="sm">
                        <Eye className="w-4 h-4 mr-2" />
                        Add to Watchlist
                      </Button>
                      <Button className="w-full justify-start text-sm bg-gradient-to-r from-purple-500/30 to-violet-600/10 hover:from-purple-600/90 hover:to-violet-700/90 text-white border border-purple-500/30 backdrop-blur-sm shadow-lg" size="sm">
      ...
      <div
        className="w-full h-[450px] border rounded-xl dark:bg-[linear-gradient(135deg,rgba(47,40,32,0.7)_0%,rgba(244,208,63,0.08)_100%)] bg-[linear-gradient(135deg,rgba(255,255,255,0.9)_0%,rgba(248,250,252,0.8)_100%)] pt-4 sm:pt-6 pb-6 sm:pb-8 px-4 sm:px-6 md:px-8 flex flex-col shadow-lg shadow-ring/10 hover:shadow-lg hover:shadow-ring/20 transition-all duration-200 ease-in-out backdrop-blur-sm relative overflow-hidden"
