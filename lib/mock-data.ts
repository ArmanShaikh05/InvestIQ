...
// Sector Comparison Data (mimics StockData structure for component compatibility)
export const sectorComparisonData: StockData[] = [
  {
    ticker: "banking",
    name: "Banking Sector",
    score: 83,
  ...
  {
    ticker: "pharmaceuticals",
    name: "Pharmaceuticals Sector",
    score: 81,
    profitability: 82,
    growth: 76,
    stability: 86,
  ...
  {
    ticker: "consumer-durables",
    name: "Consumer Durables Sector",
    score: 80,
    profitability: 79,
    growth: 77,
    stability: 82,
