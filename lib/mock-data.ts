...
export const sectors = ['Banking', 'IT', 'Auto', 'Pharma', 'FMCG', 'Energy', 'NBFC'];
export const assetTypes = ['Large Cap', 'Mid Cap', 'Small Cap', 'Blue Chip', 'Growth', 'Value'];
export const biases = ['Momentum', 'Quality', 'Low Volatility', 'High Dividend', 'ESG', 'Innovation'];
export const categories = ['Technology', 'Financial Services', 'Healthcare', 'Consumer Goods', 'Energy', 'Infrastructure'];